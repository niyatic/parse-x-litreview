...
- **OCR-specialist VLMs.** GLM-OCR (edit-distance 0.019, rank-1 specialist on the SAVIOR leaderboard; sibling to the GLM-4.5 foundation series [205]), DeepSeek-OCR-2, GOT-OCR-2.0, DocOwl2 / mPLUG-DocOwl1.5, Fox, TextMonkey, Vary-toy, Nougat-0.1.0, FireRed-OCR, Logics-Parsing-v2, Chandra (`datalab-to/chandra-ocr-2`) [10][1].
...
1. **Field-to-region grounding is essentially un-benchmarked.** DocLayNet, PubLayNet, ICDAR-2023 measure *layout* boxes; FUNSD measures *entity* boxes; none score "extracted field `total_amount` → originating page region at IoU ≥ 0.5". The `field_to_region_grounding_accuracy` metric constitutes the framework-novel surface, building on SAVIOR-Bench R9's definition [35].
...
Net delta of this review against the survey lineage: per-dimension scoring contracts, doc-type x quality x language stratification, pinned decoding, and a cost-latency dimension, none of which the four surveys above operationalize.


## D-DOC-QUALITY: stratification by document quality (Q-HIGH/MED/LOW)

D-DOC-QUALITY addresses a question that headline accuracy figures on parse benchmarks almost always obscure: when the input is a degraded scan (JPEG-Q40 compression, ≥5° rotation, motion or defocus blur, low DPI), does the engine's accuracy collapse, drift, or remain stable? In the Parse-x framework it is explicitly a **stratification** of D-OCR and D-PARSE-INTENT rather than an independent score, with the primary metric being the signed delta in `savior_word_recall` between Q-HIGH and Q-LOW renderings of the same corpus under identical decoding pins, and a Q-MED midpoint reported for monotonicity diagnosis [51]. The degradation recipe is borrowed from [52] §10 R4. Failure modes F1 (vertical/rotated text), F5 (degraded scan) and F8 (stylized text) are expected to activate disproportionately in Q-LOW [51].
...
This appendix inventories every public and internal corpus that a Parse-x leaderboard cell could draw on, records what is known about its provenance and possible model-training overlap, and pins each to one or more of the framework's seven measurement dimensions (D-OCR, D-PARSE-INTENT, D-LAYOUT, D-BBOX, D-TABLE, D-DOWNSTREAM, D-COST-LATENCY) and two stratification overlays (D-DOC-QUALITY, D-LANG) [25]. The appendix then states the standing circularity rule on `results.zip` and closes with the per-doc-type coverage-gap matrix.
...
- **Gemini 2.5 / 3.x** vision input is billed as tokens (per Google's tokenizer for images at ~258 tok/tile), so D-COST-LATENCY normalization must convert pages to tokens before cost comparisons against per-page services. The `2.6` / `3.x` line had not stabilized at the cutoff date; the pin is therefore marked `PENDING-CONFIRMATION` [132].
...
| Split / metric | Chandra | Qwen36-a3b | Tesseract | HyperAPI parse | Lead | Apples-to-oranges flag |
|---|---:|---:|---:|---:|---|---|
...
[6] Cui, C., Sun, T., Liang, S., Gao, T., Zhang, Z., Liu, J. et al. PaddleOCR-VL-1.5: Towards a Multi-Task 0.9B VLM for Robust In-the-Wild Document Parsing. arXiv:2601.21957 (2026). https://arxiv.org/abs/2601.21957 (also ERNIE Blog https://ernie.baidu.com/blog/posts/paddleocr-vl-1.5/). 0.9B VLM; 94.5% on OmniDocBench v1.5; submitted 2026-01-29, revised 2026-04-03.
...
[136] Microsoft. What's new in Azure OpenAI in Microsoft Foundry Models. Microsoft Learn (rolling). https://learn.microsoft.com/en-us/azure/ai-services/openai/whats-new, release-cadence reference; Azure pages frequently rotate older snapshot dates out of the changelog, so individual snapshot identifiers (e.g., gpt-5 2025-08-07) may not be visible on a given crawl.
...
[167] Shi, J.; Shi, C. A Review On Table Recognition Based On Deep Learning. arXiv:2312.04808, 2023. URL https://arxiv.org/abs/2312.04808
[168] Ding, Y.; Luo, S.; Dai, Y.; Jiang, Y.; Li, Z.; Sun, Q.; Martin, G.; Liu, W.; Peng, Y. A Survey on MLLM-based Visually Rich Document Understanding: Methods, Challenges, and Emerging Trends. arXiv:2507.09861, 2025 (ACL 2026 Findings). URL https://arxiv.org/abs/2507.09861
[169] Ding, Y.; Han, S. C.; Lee, J.; Hovy, E. Deep Learning based Visually Rich Document Content Understanding: A Survey. arXiv:2408.01287, 2024. URL https://arxiv.org/abs/2408.01287
[170] Somvanshi, S.; Das, S.; Javed, S. A.; Antariksa, G.; Hossain, A. A Survey on Deep Tabular Learning. arXiv:2410.12034, 2024. URL https://arxiv.org/abs/2410.12034
[171] Barboule, C.; Piwowarski, B.; Chabot, Y. Survey on Question Answering over Visually Rich Documents: Methods, Challenges, and Trends. arXiv:2501.02235, 2025. URL https://arxiv.org/abs/2501.02235
[172] UiPath. Document Understanding (IXP) product page. uipath.com, accessed 2026-06-16. URL https://www.uipath.com/product/document-understanding
[173] Amazon Web Services. Amazon Textract product page. aws.amazon.com, accessed 2026-06-16. URL https://aws.amazon.com/textract/
[174] Google Cloud. Document AI product overview. cloud.google.com, accessed 2026-06-16. URL https://cloud.google.com/document-ai
[175] Hyperscience. Hypercell platform overview (ORCA VLM, Accuracy Harness). hyperscience.ai, accessed 2026-06-16. URL https://www.hyperscience.ai/platform/
[176] Rossum (Coupa). Enterprise automation platform overview (transactional LM, 276 languages). rossum.ai, accessed 2026-06-16. URL https://rossum.ai/platform/
[177] Microsoft. Overview of document processing for Microsoft 365 (formerly Syntex). Microsoft Learn, updated 2025-08-01. URL https://learn.microsoft.com/en-us/microsoft-365/syntex/syntex-overview
[178] Marti, U.-V. & Bunke, H. The IAM-database: an English sentence database for offline handwriting recognition. International Journal on Document Analysis and Recognition (IJDAR) 5(1):39-46, 2002. DOI: 10.1007/s100320200071. URL https://link.springer.com/article/10.1007/s100320200071
[179] Li, M., Lv, T., Chen, J., Cui, L., Lu, Y., Florencio, D., Zhang, C., Li, Z. & Wei, F. TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models. arXiv:2109.10282, 2021. URL https://arxiv.org/abs/2109.10282
[180] Garrido-Munoz, C., Rios-Vila, A. & Calvo-Zaragoza, J. Handwritten Text Recognition: A Survey. arXiv:2502.08417, Feb 2025. URL https://arxiv.org/abs/2502.08417
[181] Crosilla, G., Klic, L. & Colavizza, G. Benchmarking Large Language Models for Handwritten Text Recognition. arXiv:2503.15195, Mar 2025. URL https://arxiv.org/abs/2503.15195
[182] Retsinas, G., Sfikas, G., Gatos, B. & Nikou, C. Best Practices for a Handwritten Text Recognition System. arXiv:2404.11339, Apr 2024 (DAS 2022 extended). URL https://arxiv.org/abs/2404.11339
[183] Deng, Y., Kanervisto, A., Ling, J., Rush, A. M. Image-to-Markup Generation with Coarse-to-Fine Attention. ICML 2017. arXiv:1609.04938. URL https://arxiv.org/abs/1609.04938
[184] Mahdavi, M., Zanibbi, R., Mouchere, H., Viard-Gaudin, C., Garain, U. ICDAR 2019 CROHME + TFD: Competition on Recognition of Handwritten Mathematical Expressions and Typeset Formula Detection. ICDAR 2019. URL https://ieeexplore.ieee.org/document/8978036/
[185] Blecher, L. pix2tex / LaTeX-OCR: a ViT-encoder Transformer-decoder system that converts math-formula images into LaTeX. Open-source project. URL https://github.com/lukas-blecher/LaTeX-OCR
[186] Harley, A. W., Ufkes, A., Derpanis, K. G. Evaluation of Deep Convolutional Nets for Document Image Classification and Retrieval. ICDAR 2015. arXiv:1502.07058. URL https://arxiv.org/abs/1502.07058
[187] Kumar, J., Ye, P., Doermann, D. Structural similarity for document image classification and retrieval (Tobacco-3482 dataset, 3,482 documents across 10 classes drawn from the Truth Tobacco Industry Documents archive). 2014.
[188] Extend AI. Parse 2.0 and RealDoc-Bench: SOTA layout-first document parsing. Product launch, 2026. URL https://www.extend.ai/resources/parse-2-and-realdocbench-launch
[189] Extend AI. RealDoc-Bench: A Real-World Benchmark for Document Agents. 2026. 1,500 real-world documents across healthcare, financial services, logistics, real estate. URL https://www.extend.ai/resources/realdocbench
[190] xAI. Grok 4 model family (Generalist, Heavy, Code). Released July 2025; Grok 4.3 beta April 2026 with native multimodal video and improved long-context reasoning; 256k context. URL https://x.ai/news/grok-4
[191] Meta AI. The Llama 4 Herd: Scout (109B / 16 experts / 10M-token context), Maverick (400B / 128 experts / 1M-token context), Behemoth (~2T / 288B active, previewed). First Llama with native multimodality via early-fusion. Released April 2025. URL https://ai.meta.com/blog/llama-4-multimodal-intelligence/
[192] Mindee. Document AI API platform; invoice, receipt, ID, custom-document extraction. Product site, accessed 2026-06-16. URL https://www.mindee.com/
[193] Veryfi. Real-time invoice and receipt data extraction API (GDPR / HIPAA compliant). Accessed 2026-06-16. URL https://www.veryfi.com/
[194] Affinda. AI document processing platform; invoice, receipt, resume, ID extraction. Accessed 2026-06-16. URL https://www.affinda.com/
[195] Klippa. Document processing (financial documents, receipts, invoices); multilingual; affordable tier for SMBs. Accessed 2026-06-16. URL https://www.klippa.com/en/
[196] Wang, Z. et al. Modeling Layout Reading Order as Ordering Relations for Visually-rich Document Understanding. EMNLP 2024. URL https://aclanthology.org/2024.emnlp-main.540/
[197] Coquenet, D., Chatelain, C., Paquet, T. End-to-End Handwritten Document Recognition (LOER: Layout Ordering Error Rate). 2022. arXiv:2209.15362. URL https://arxiv.org/abs/2209.15362
[198] Ocrolus. Ocrolus Products: Document automation and analytics for financial services. Vendor page, 2026. https://www.ocrolus.com/
[199] Nanonets. Agentic Data Extraction and AI Agents for Enterprise Data Processing. Vendor page, 2026. https://nanonets.com/
[200] Sensible. Sensible: Document Extraction Platform (LLM-flexible, deterministic guardrails; SenseML config-as-code). Vendor page, 2026. https://sensible.so/
[201] Microsoft. Phi-4-multimodal-instruct (5.6B; text+vision+speech; 128K ctx; OCRBench 84.4, DocVQA 93.2, TextVQA 75.6). Hugging Face model card, Feb 2025. https://huggingface.co/microsoft/Phi-4-multimodal-instruct
[202] Adobe. Acrobat AI Assistant: Generative AI document & PDF tool. Adobe product page, 2026. https://www.adobe.com/acrobat/generative-ai-pdf.html
[203] Mistral AI. Magistral: Mistral's first reasoning model (Magistral Small 24B Apache-2.0; Magistral Medium enterprise). News post, 2025-06-10. https://mistral.ai/news/magistral
[204] Mistral AI & All Hands AI. Devstral: An agentic LLM for software-engineering tasks (24B, Apache-2.0; SWE-Bench Verified 46.8%). News post, 2025-05-21. https://mistral.ai/news/devstral
[205] Z.ai (THUDM). GLM-4.5: Open-source foundation model for intelligent agents (355B total / 32B active; thinking + standard modes; MIT license). Hugging Face model card, 2025. https://huggingface.co/zai-org/GLM-4.5
[206] Li, M., Xu, Y., Cui, L., Huang, S., Wei, F., Li, Z., Zhou, M. DocBank: A Benchmark Dataset for Document Layout Analysis. COLING 2020 / arXiv:2006.01038. https://arxiv.org/abs/2006.01038
[207] Wang, Z., Xu, Y., Cui, L., Shang, J., Wei, F. LayoutReader: Pre-training of Text and Layout for Reading Order Detection (introduces ReadingBank, 500K document images). EMNLP 2021 / arXiv:2108.11591. https://arxiv.org/abs/2108.11591
[208] Zhong, X., ShafieiBavani, E., Jimeno Yepes, A. Image-based table recognition: data, model, and evaluation (PubTabNet; introduces TEDS-Structure and TEDS-Cell). ECCV 2020 / arXiv:1911.10683. https://arxiv.org/abs/1911.10683
[209] Mathew, M., Karatzas, D., Jawahar, C.V. DocVQA: A Dataset for VQA on Document Images (introduces ANLS evaluation for DocVQA). WACV 2021 / arXiv:2007.00398. https://arxiv.org/abs/2007.00398
